...
class Manage_internship extends Handle_file_upload {
  constructor(props) {
    super(props);
  ...
  submit = async () => {
    let { sections, image, image_file_hash, title, internship } = this.state;
    if (!internship) return;

    this.setState({ updating: true, message: null });

    internship = { sections, image, image_file_hash, title };

    let res = await post_request("update_internship", internship);
  ...
  render() {
    ...
    return (
      <div className="col-12">
        <Dashboard_breadcrumb crumb="Internship" />
        <div className="row justify-content-center">
          <div className="col-md-8 col-lg-8 col-xl-6 col-sm-12">
            <div className="crs_grid">
              <div className="modal-header">
                <h5 className="modal-title text-dark">Internship</h5>
              </div>
...
export default Manage_internship;
