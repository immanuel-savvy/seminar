...
class Manage_mentorship extends Handle_file_upload {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      <div className="col-12">
        <Dashboard_breadcrumb crumb="Mentorship" />
        <div className="row justify-content-center">
          <div className="col-md-8 col-lg-8 col-xl-6 col-sm-12">
            <div className="crs_grid">
              <div className="modal-header">
                <h5 className="modal-title text-dark">Mentorship</h5>
              </div>
...
export default Manage_mentorship;
