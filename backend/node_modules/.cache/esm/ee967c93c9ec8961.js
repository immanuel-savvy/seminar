let USERS,USERS_HASH,nodemailer,generate_random_string,verification,remove_image,save_image;_c9e‍.x([["signup",()=>signup],["login",()=>login],["user_by_email",()=>user_by_email],["user",()=>user],["send_mail",()=>send_mail],["verify_email",()=>verify_email],["to_title",()=>to_title],["update_user",()=>update_user],["users",()=>users]]);_c9e‍.w("../ds/conn",[["USERS",["USERS"],function(v){USERS=v}],["USERS_HASH",["USERS_HASH"],function(v){USERS_HASH=v}]]);_c9e‍.w("nodemailer",[["default",["nodemailer"],function(v){nodemailer=v}]]);_c9e‍.w("generalised-datastore/utils/functions",[["generate_random_string",["generate_random_string"],function(v){generate_random_string=v}]]);_c9e‍.w("./emails",[["verification",["verification"],function(v){verification=v}]]);_c9e‍.w("./utils",[["remove_image",["remove_image"],function(v){remove_image=v}],["save_image",["save_image"],function(v){save_image=v}]]);
...
const send_mail = ({
  ...
  try {
    ...
    _c9e‍.g.console.log("in here with", recipient);
  } catch (e) {}
  ...
  try {
    transporter
      ...
      .then(() => {})
      .catch((e) => _c9e‍.g.console.log(e));
    _c9e‍.g.console.log("Email sent", recipient);
  } catch (e) {}
};
...
const signup = (req, res) => {
  ...
  _c9e‍.g.console.log(user_exists, user.email);
  if (user_exists)
    return res.json({
      ok: false,
      message: "user exists",
